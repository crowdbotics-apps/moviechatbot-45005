"""
Django settings for moviechatbot_45005 project.
...
ROOT_URLCONF = 'moviechatbot_45005.urls'
...
WSGI_APPLICATION = 'moviechatbot_45005.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "moviechatbot_45005 API",
    "DESCRIPTION": "API documentation for moviechatbot_45005 App",
    "VERSION": "v1",
}
